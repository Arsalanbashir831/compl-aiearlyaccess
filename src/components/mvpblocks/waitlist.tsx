          ...
          <AnimatePresence mode="wait">
            {!submitted ? (
              ...
              <motion.div
                ...
                className="border-primary/20 from-primary/10 to-primary/10 text-primary flex-1 cursor-pointer rounded-xl border bg-linear-to-r via-transparent px-6 py-4 font-medium backdrop-blur-md transition-all duration-300 hover:shadow-[0_0_20px_rgba(10,89,235,0.3)] active:brightness-125 glass2"
              >
          ...
          <div className="flex -space-x-3">
            {users.map((user, i) => (
              <motion.div
                ...
                className="border-background from-primary size-10 rounded-full border-2 bg-linear-to-r to-[#0a59eb] p-[2px]"
              >
